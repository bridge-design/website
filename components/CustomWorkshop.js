  ...
  return (
    <div className="max-w-4xl mx-auto mt-28">
      ...
      <Text variant="xlMedium" className="flex mt-16">
        ...
        process, how to get started and how to fit it into your existing design processes. There
        will be an opportunity for the team to discuss questions they might have about implementing
        a design system.
      </Text>
      <Button
