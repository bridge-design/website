...
<LayoutCase
  ...
  team={['varya']}
  logo="/logo/f-secure-logo.svg"
  description="Exploring the collaborative journey of developing a design system strategy at F-Secure, highlighting the principles, roadmap, and tool recommendations aimed at fostering excellent digital experiences."
  seo={{
    desc: "Exploring the collaborative journey of developing a design system strategy at F-Secure, highlighting the principles, roadmap, and tool recommendations aimed at fostering excellent digital experiences."
  }}
>
...
export const metadata = {
  title: "F-Secure's Design System Strategy",
  description:
    "Exploring the collaborative journey of developing a design system strategy at F-Secure, highlighting the principles, roadmap, and tool recommendations aimed at fostering excellent digital experiences.",
};
