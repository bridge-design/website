...
<LayoutHandout title="Coding practice">
...
1. Navigate to the _Settings_ tab on your repository's page
1. Scroll a bit down and choose _Pages_ in the sidebar menu
1. Select `gh-pages` branch as a _Source_ and save
...
You can see in `design-system/src/tokens/dist/` how _color_ and _typography_
