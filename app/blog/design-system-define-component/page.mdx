...
export const metadata = {
  title: "Define your Rock-Solid Design System Components",
  description:
    "Craft exceptional design systems with clear and collaborative component definitions. Discover how our process ensures strong, maintainable components that boost communication, speed up development, and guarantee a seamless user experience.",
};
