export const parts = [
  ...
  },
  {
    title: 'Editorial',
    category: true,
    parts: ['Voice & tone', 'Writing for the web', 'Word list', 'Capitalization', 'Punctuation'],
  },
  {
    title: 'Branding',
    category: true,
  ...
  },
  {
    ...
    category: true,
    parts: ['User needs', 'Personas', 'Research techniques', 'Surveys', 'A/B, multivar. testing'],
  },
  {
    title: 'Practices',
    category: true,
    parts: ['Accessibility', 'Prototyping', 'Performance', 'Reviews', 'Design thinking'],
  },
  {
    title: 'Coding standards',
    category: true,
    parts: ['Style', 'Browsers & devices', 'Environments', 'Prog. enhancement', 'Version control'],
  },
  {
    title: 'Downloads',
    category: true,
  ...
  },
  {
    ...
    category: true,
    parts: ['Home page', 'Principles / pillars', 'Getting started', 'FAQ', 'Changelog'],
  },
  {
