...
description: >
    Refining Yara design system: in this project, we enreached a React library with 10 new components,
    upgraded to Storybook@7, improved accessibility, and restructured tokens. Key efforts included
    infrastructure optimization, thorough documentation overhaul, and customizing the Storybook UI based
    on user feedback.
seo:
  desc: >
