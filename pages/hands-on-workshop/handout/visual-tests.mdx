...
<LayoutHandout title="Visual Regression testing">
...
Then run in **separate** terminal window:
...
**By default the tests are configured for chrome desktop and mobile only. [Refer to documentation](https://loki.js.org/configuration.html) if you want to extend your configuration.**
