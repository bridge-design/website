...
export const Blob = ({ color = '#4a90e2', size = 300 }) => {
  return (
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" style={{ color }}>
          <style>
            ...
            @keyframes stable {
                ...
                to { transform: translate(50px, 50px) rotate(0deg); }
            }
              ...
              .blob1, .blob2, .blob3 {
                animation: stable 0.5s linear infinite;
              }
              .group:hover .blob1 {
