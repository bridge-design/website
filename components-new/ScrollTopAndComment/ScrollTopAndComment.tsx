    ...
    >
      {siteMetadata.comments?.provider && (
        <button
          ...
          className="rounded-full bg-[var(--btg-color-background)] p-2 text-[var(--btg-color-link)] transition-all hover:bg-[var(--btg-color-grey-300)] dark:bg-[var(--btg-color-grey-700)] dark:text-[var(--btg-color-link)] dark:hover:bg-[var(--btg-color-grey-600)]"
        >
