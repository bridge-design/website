...
import * as styles from './HorizontalWave.module.css'
...
export const HorizontalWave: React.FC<HorizontalWaveProps> = ({
  direction = 'down',
  color = 'currentColor',
}) => {
  return (
    <div
      ...
      style={{
        color,
        transform: direction === 'top' ? 'rotate(180deg)' : undefined,
      }}
    >
