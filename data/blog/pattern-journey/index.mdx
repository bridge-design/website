...
summary: >
    ...
    umbrella.
canonicalUrl: https://varya.me/design-systems/pattern-journey/
images: ['/images/blog/pattern-journey/thumb.png']
---
...
![](/images/blog/pattern-journey/pattern-addition-flowchart.png)<br/>
...
![](/images/blog/pattern-journey/pattern-journey.png)
...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/kKnTN3EswnU"
  frameborder="0"
...
![](/images/blog/pattern-journey/pattern-journey__pattern-library--implement-new.png)
...
for its documentation. Use the component as it is documented. If you have question, do not hesitate
to ask in the instant communication channels (Slack, Flowdock, etc). The suggestions and pull
requests for the documentation improvement are very welcome.

### Taking the pattern from another project

![](/images/blog/pattern-journey/pattern-journey__pattern-library--from-other-project.png)
...
![](/images/blog/pattern-journey/pattern-journey__pattern-library--fix-pattern.png)
...
<i>Design System / Pattern Library website</i>
and all the examples provided. This way, you can understand if the pattern is suitable for your
specific task.
