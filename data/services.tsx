...
export const EXPERTISE = [
  ...
  },
  {
    ...
    description: `We optimize your workflows to brige the gap (😜) between design and development. For faster and brave updates, we create automated testing and streamlined development via tuned CI/CD. We automate gathering data about your design system usage (or not usage!) to empower you for your next decisions.`,
  },
  {
